...
class JiraSubmit(FlaskForm):
    ...
    field = SelectField("领域：", validators=[DataRequired(
        "Please enter")], choices=[(1, "test"), (2, "dev")])
    module = SelectField("模块：", validators=[DataRequired(
        "Please enter")], choices=[(1, "test"), (2, "dev")])
    assignee = SelectField("处理人：", validators=[DataRequired(
        "Please enter")], choices=[(1, "test"), (2, "dev")])
    versions = SelectField("影响版本：", validators=[DataRequired(
        "Please enter")], choices=[(1, "test"), (2, "dev")])
    severity = SelectField("严重程度：", validators=[DataRequired(
        "Please enter")], choices=[(1, "test"), (2, "dev")])
