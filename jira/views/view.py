...
@app.route('/jira_list')
def jira_list():
	res = ModeJira.exec("select id,pid,issuetype,summary,description,versiontype,field,module,assignee,versions,severity,reproduce,f_date from j_issues_list;")
